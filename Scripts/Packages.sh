...
UPDATE_PACKAGE "daede" "kenzok8/openwrt-daede" "main" "" "luci-app-daede daed dae"
UPDATE_PACKAGE "homeproxy" "XiaoHaiSly/luci-app-homeproxy" "main" "" "luci-app-homeproxy sing-box"
